    ...
    <>
      <nav style={{
        ...
        <div onClick={() => router.push('/')} style={{
          fontSize: '22px', fontWeight: 800, color: 'var(--teal)',
          cursor: 'pointer', letterSpacing: '-1px',
          display: 'flex', alignItems: 'center', gap: '2px',
        }}>
          kydo<span style={{ color: 'var(--amber)' }}>.</span>
          <span style={{
            fontSize: '10px', fontWeight: 400, color: 'var(--gray)',
            letterSpacing: '.5px', marginLeft: '3px',
        ...
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
          <span
            ...
            style={{
              ...
              padding: '8px 12px', borderRadius: '24px', fontWeight: 500,
            }}
            className="nav-link"
          >
            Αναζήτηση
          ...
          {!user ? (
            ...
            <div ref={menuRef} style={{ position: 'relative' }}>
              ...
              >
                <span style={{ fontSize: '13px', fontWeight: 600 }}>{firstName}</span>
                <div style={{
